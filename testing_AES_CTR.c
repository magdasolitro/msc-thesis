...
int main(){
    ...
    AES_KEY aes_key;
    unsigned char ivec[] = {
        0x00, 0xee, 0x22, 0x33, 0xcc, 0x55, 0x66, 0x00,
        0xff, 0x99, 0xaa, 0x11, 0x22, 0xdd, 0xee, 0x77
    };

    // temporary buffer that holds the counter's encryption
    unsigned char ecount_buf[16];

    /*
    holds the state information in a form of the number of bytes used out of the
    total block size.
    */
    unsigned int *num;
    ...
    CRYPTO_ctr128_encrypt((const unsigned char *) in, out, len, key, ivec,
        ecount_buf, num, (block128_f) AES_encrypt);
