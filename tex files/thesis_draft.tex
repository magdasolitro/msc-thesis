...
cache = array[value];		// look-up
	...
	\appendix
	\chapter{Program analysis techniques}\label{appendix:prog_analysis}
	\section{Taint analysis}
	References: \cite{Newsome2005}, \cite{Bayer2009}, \cite{Yin2007}, \cite{Balzarotti2008}, \cite{NguyenTuong2005}.
