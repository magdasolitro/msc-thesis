...
uint8_t foo(uint32_t x) { 
	...
	\]
	where the operator $\langle \cdot , ..., \cdot \rangle$ represents a a generic combination. In the rest of the section, we will describe the modes of operation that we tested in this thesis. 
